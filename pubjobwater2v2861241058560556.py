...
now = datetime.now()
fname = now.strftime('%Y-%m-%d') + 'pubjobwater2V2_861241058560556mormal.log'
...
HOST = "47.101.220.2"
PORT = 1883
topic = "/set/OUTDOOR00012798" #室外机新
