...
while count <= 9912:
    ...
    url = ("https://asia.pokemon-card.com/tw/card-img/tw0000{}.png").format(count) 
    
    # url = ("https://limitlesstcg.nyc3.digitaloceanspaces.com/tpci/SSP/SSP_{}_R_EN.png").format(count) 
    
    filename = ("tw0000{}.png").format(count)  # Replace with the desired filename for the downloaded image
